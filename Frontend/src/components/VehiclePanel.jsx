...
const VehiclePanel = ({setVehiclePanel,setConfirmRidePanel}) => {
  return (
    <div>
      <h5 onClick={()=>setVehiclePanel(false)} className="-m-2 text-center absolute top-0 w-[93%]"><i className=" text-3xl text-gray-300 ri-arrow-down-wide-line"></i></h5>
        <h3 className="text-xl font-semibold mb-5">Choose a Vehicle</h3>
              {/* 1st ride */}
        <div onClick={()=>{setConfirmRidePanel(true)}} className="flex w-full items-center justify-between border-black rounded-xl h-20 bg-gray-100  p-2 space-x-2">
          ...
          <h2 className="font-semibold">₹193.20</h2>
              ...
              {/* 2nd ride */}
        <div onClick={()=>{setConfirmRidePanel(true)}} className="flex w-full items-center justify-between active:border-black rounded-xl bg-gray-100 p-2 space-x-2">
          ...
          <h2 className="font-semibold">₹65.20</h2>
        </div>

      {/* 3rd ride */}
        <div onClick={()=>{setConfirmRidePanel(true)}} className="flex w-full items-center justify-between active:border-black rounded-xl h-20 bg-gray-100 p-2 space-x-2">
          ...
          <h2 className="font-semibold">₹43.20</h2>
        </div>
    </div>
  )
}
